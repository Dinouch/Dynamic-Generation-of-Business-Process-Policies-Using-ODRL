...
corresponding pattern_type string here so Agent 1 tags anything else as unhandled
...
# BPMN 2.0 semantics for unhandled pattern_type values (English, one sentence each).
