...
corresponding pattern_type string here so Agent 1 tags anything else as unmapped
...
# BPMN 2.0 semantics for unmapped pattern_type values (English, one sentence each).
