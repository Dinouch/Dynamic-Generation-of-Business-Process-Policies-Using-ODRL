...
class EvaluationPipeline:
    ...
    def _process_model(self, bpmn_file):
        ...
        if not bp_model_data:
            model_result["status"] = "parse_failed"
            return model_result
        bp_model_data = parser.convert_ids_to_names(bp_model_data)
        ...
        start_time = time.time()
        fragmenter = SemanticFragmenter(bp_model_data)
