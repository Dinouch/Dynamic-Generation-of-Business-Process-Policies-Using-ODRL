...
# Ce fichier vit dans src/unused_evaluation/ — ajouter src au path pour imports du package.
_SRC = os.path.abspath(os.path.join(os.path.dirname(__file__), ".."))
if _SRC not in sys.path:
    sys.path.insert(0, _SRC)

from unused_evaluation.evaluation_pipeline import EvaluationPipeline
