...
# Ce fichier vit dans src/legacy_evaluation/ — ajouter src au path pour legacy_evaluation + baseline
_SRC = os.path.abspath(os.path.join(os.path.dirname(__file__), ".."))
if _SRC not in sys.path:
    sys.path.insert(0, _SRC)

from legacy_evaluation.evaluation_pipeline import EvaluationPipeline
